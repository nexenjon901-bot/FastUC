...
const Header: React.FC<HeaderProps> = ({ balance = 0 }) => {
  ...
  return (
    <div
      style={{ background: '#111321', borderBottom: '1.5px solid #3C4378', height: 60 }}
    ...
    >
      ...
      <div className="flex items-center gap-2.5">
        {/* Avatar */}
        <div
          style={{ background: 'linear-gradient(135deg, #6F78F0, #858CF5)', width: 38, height: 38 }}
      ...
      >
        <svg width="15" height="15" fill="none" viewBox="0 0 24 24">
          <path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2v10z" stroke="#6F78F0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
        <span style={{ color: '#F5F5FF', fontSize: '0.8rem' }} className="font-bold">Fikrlar</span>
      </button>
    </div>
  );
};
